...
public class OCR extends AppCompatActivity {
    ...
    Button captureImg, detectText,send;
    ImageView imageView;
    EditText mResult;
...
//                AddMedicineFragment m4=new AddMedicineFragment();
//                m4.setArguments(bundle);
//                getSupportFragmentManager().beginTransaction().add(R.id.container,m4).commit();
//            }
//        });

        detectText = findViewById(R.id.detect_image);
        imageView = findViewById(R.id.img);
        mResult = findViewById(R.id.textOCR);
        ...
        detectText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imageBitmap != null) {
                    ...
                    Toast.makeText(OCR.this, "Select something", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }

...
import static com.example.healthcare.C_PeriodicalDatabase.DayEntry.PERIOD_CONFIRMED;
import static com.example.healthcare.C_PeriodicalDatabase.DayEntry.PERIOD_START;

/**
 * The main activity of the app
 */
public class C_MainActivityApp extends AppCompatActivity
    ...
    private void showHelp() {
        startActivityForResult(
                new Intent(C_MainActivityApp.this, C_HelpActivity.class), HELP_CLOSED);
    }
    ...
    private void showAbout() {
        startActivityForResult(
                new Intent(C_MainActivityApp.this, C_AboutActivity.class), ABOUT_CLOSED);
    }
    ...
    private void showList() {
        startActivityForResult(
                new Intent(C_MainActivityApp.this, C_ListActivity.class), PICK_DATE);
    }
    ...
    private void showListDetails() {
        startActivityForResult(
                new Intent(C_MainActivityApp.this, C_ListDetailsActivity.class), PICK_DATE);
    }
    ...
    private void showOptions() {
        startActivityForResult(
                new Intent(C_MainActivityApp.this, C_PreferenceActivity.class), SET_OPTIONS);
    }
    ...
    private void calendarUpdate() {
        ...
        C_PreferenceUtils preferences = new C_PreferenceUtils(context);
...
//                getResources().getString(R.string.label_longest_cycle), dbMain.cycleLongest));
        ...
        for (int i = 1; i <= 42; i++) {
            ...
            if (i < firstDayOfWeek || i >= firstDayOfWeek + daysCount) {
                ...
                C_PeriodicalDatabase.DayEntry entry = dbMain.getEntry(cal);
                ...
                if (entry != null) {
                    ...
                    cell.setType(C_PeriodicalDatabase.DayEntry.EMPTY);
    ...
    public void goPrev(View v) {
        ...
        flipper.setInAnimation(C_AnimationHelper.inFromLeftAnimation());
        flipper.setOutAnimation(C_AnimationHelper.outToRightAnimation());
        flipper.showNext();
    }
    ...
    public void goNext(View v) {
        ...
        ViewFlipper flipper = findViewById(R.id.mainwidget);
        flipper.setInAnimation(C_AnimationHelper.inFromRightAnimation());
        flipper.setOutAnimation(C_AnimationHelper.outToLeftAnimation());
        ...
        if (preferences.getBoolean("direct_details", false)) {
            ...
            if (type != PERIOD_START && type != PERIOD_CONFIRMED) {
                ...
                if (type == PERIOD_START)
                    builder.setMessage(getResources().getString(R.string.ccalendaraction_removeperiod));
    ...
    private void showDetailsActivity(int year, int month, int day) {
        Intent details = new Intent(C_MainActivityApp.this, C_DetailsActivity.class);
